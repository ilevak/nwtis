 ...
 */
package org.foi.nwtis.ilevak.rest.klijenti;
...
public class Zadaca2_2RS {
    ...
    private static final String BASE_URI = "http://localhost:8080/ilevak_zadaca_2_2/webresources";
    ...
    public Response dodajMojAerodrom(Object requestEntity) throws ClientErrorException {
    ...
    public <T> T dajAerodromNazivDrzava(Class<T> responseType, String drzava, String naziv) throws ClientErrorException {
    ...
    public <T> T dajMojAerodromIcao(Class<T> responseType, String icao) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}", new Object[]{icao}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON)
                .header("korisnik", korisnik)
                .header("lozinka", lozinka).get(responseType);
    }
